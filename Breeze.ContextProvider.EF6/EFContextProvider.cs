...
namespace Breeze.ContextProvider.EF6 {
  ...
  public class EFContextProvider<T> : Breeze.ContextProvider.ContextProvider, IEFContextProvider where T : class, new() {
    ...
    public static String GetMetadataFromContextWithoutMapping(Object context)
    {
        if (context is DbContext)
        {
            return GetMetadataFromDbContext(context, false);
        }
        else
        {
            return GetMetadataFromObjectContext(context, false);
        }
    }

    private static String GetMetadataFromDbContext(Object context, bool updateCSpaceOSpaceMapping = true) {
    ...
    private static String GetMetadataFromObjectContext(Object context, bool updateCSpaceOSpaceMapping = true)
    {
